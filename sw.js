...
const CACHE = "ninsai-kakurenbo-v6";
...
const CORE = [
  "./", "./index.html", "./style.css?v=6", "./chars.js?v=6", "./balance.js?v=6", "./castle.js?v=6", "./data.js?v=6", "./sim.js?v=6", "./render.js?v=6", "./net.js?v=6", "./game.js?v=6",
