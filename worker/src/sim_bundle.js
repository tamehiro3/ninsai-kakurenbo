// ===== chars.js（自動コピー・編集しない） =====
// CryptoNinja 公式39体（自動生成：tools/build_chars.py・出典 ninja-dao.com/characters・名前の正本は cnp-3d/ref_official/roster.json）
const CHARS_ALL = [
 {
  "id": "jin",
  "num": "001",
  ...
  "weaponEn": "Shuriken",
  "birthday": "9月20日",
  "bio": "忍者の祖。謎多き伝説の忍者。風魔の初代首領と戦って命を落としたと見られている。",
  "bioEn": "The forefather of ninja. A legendary, enigmatic shinobi. Believed to have lost his life battling the first leader of the Fuma clan.",
  "color": "#26262B",
  "palette": [
   "#F6DCC1",
   "#26262B",
  ...
  "look": "全身が真っ黒な正統派忍者。黒頭巾で頭部がすっぽり覆われ、額に3つの菱形リベットが並ぶ銀灰色の鉢金プレート付き黒鉢巻（結び目の垂れが左側に出る）、鼻から下は黒い口布で覆い、切れ長で吊り上がった黒い目だけが覗く。両前腕に鎖帷子メッシュ入りのガンメタ手甲、胸元と袖口にも黒い網目、灰色の金属質な帯に蝶結び型のバックル、右手に大型の四方手裏剣、右肩越しに黒柄・金色の鍔と柄頭の刀を背負う。足元は黒足袋に灰色の甲板と茶色の草履底。",
  "painted": true
 },
 {
  "id": "sakuya",
  ...
  "weaponEn": "Shuriken",
  "birthday": "3月27日",
  "bio": "岩爺の孫。多様な召喚術を持つ。狐白と双子。繁栄の女神コノハナサクヤヒメがネーミングのもと。",
  "bioEn": "Ganzi's granddaughter. Commands a wide variety of summoning arts. Twin sister of Kohaku. Named after Konohanasakuya-hime, the goddess of prosperity.",
  "color": "#D2669E",
  "palette": [
   "#F8DDC3",
   "#28222A",
  ...
  "look": "ぱっつん前髪＋高い位置の黒いポニーテールで、結び目に赤い大きなリボン、額にはピンク（#D45BA0前後）の布鉢巻（金属プレートなし・結び目の垂れが左に出る）。ピンクの短い着物風装束に黒い縁取りと黒のたすき掛け、金茶色の帯を前で蝶結び、裾はスカート状に開く。両腕に黒い筒状の手甲（袖ではなく装備）、脚は黒のニーハイソックス、黒足袋草履に茶色の底。頬に薄い赤み、右手に大型の四方手裏剣、右肩越しに黒柄・金鍔の刀を背負う。",
  "painted": true
 },
 {
  "id": "kohaku",
  ...
  "look": "顔全体を白い狐面（耳付き・耳の内側と口元が赤、額と目の下に水色の雫状の隈取り、細い笑い目と黒い口）で覆っているため素顔は見えない。黒髪は高いポニーテールで結び目にターコイズ色のリボン、紫の布鉢巻（垂れが左に出る）。紫の短い着物風装束に黒のたすき掛け、青紫の帯を前で結び、裾はスカート状。両腕に黒い筒状の手甲、脚は明るいグレーのニーハイソックス、黒足袋草履（甲に紫の差し色）＋茶色の底。右手に抜き身の刀（黒柄・金の鍔・銀の刃）を下段に構える。",
  "painted": true
 },
 {
  "id": "shiba",
  ...
  "weaponEn": "Karate",
  "birthday": "11月1日",
  "bio": "普段は犬の姿だが、戦闘時には忍術を使って人間化して体術を使う。",
  "bioEn": "Usually takes the form of a dog, but in battle uses ninjutsu to take human form and fight with martial arts.",
  "color": "#46703E",
  "palette": [
   "#E3AA60",
   "#F4F0E8",
  ...
  "look": "柴犬の獣人キャラ。橙茶色の毛並みに白いマズル・眉斑・胸元・尾先のツートン、三角の立ち耳（内側は白）、黒い鼻と小さなピンクの舌、丸く黒い瞳に白いハイライト。深緑の鉢巻に3つの菱形が並ぶ灰色の鉢金プレート（結び目の垂れが左）。緑の忍装束に黒いたすき掛けと黒帯＋灰色の蝶型バックル、袖から橙色の腕と白い手が出る。背後に巻いた尻尾。右肩越しに黒柄・金鍔の刀を背負い、両手は空。足元は白い足袋に黒い鼻緒の草履＋茶色の底。",
  "painted": false
 },
 {
  "id": "kanaoni",
  ...
  "weaponEn": "Gyuto",
  "birthday": "11月8日",
  "bio": "奥地に住む伝説の鍛冶師。クランに縛られない存在。",
  "bioEn": "A legendary blacksmith living deep in the mountains. Bound to no clan.",
  "color": "#33505D",
  "palette": [
   "#F2DFC4",
   "#33505D",
  ...
  "look": "濃い青緑（ダークティール）の忍装束と頭巾に、顔全体を覆う赤い鬼面（般若風・眉間に皺、オレンジ赤に光る目、上下に銀色の牙、生成り色の角が2本）。赤い布鉢巻を頭巾の上から巻き（垂れが左に出る）、肩まわりに藁のような淡褐色のファー襟巻きを羽織る。胸元は網目編みで、生成り色の紐を前で結び、黒のたすき掛けと灰色の帯＋バックル。両前腕に鎖帷子入りの銀色メタル手甲、右手に幅広の銀色の短刀（鉈状）を提げ、背中に装備は無し。足元は黒い草履に薄茶の紐を足首まで巻いている。",
  "painted": false
 },
 {
  "id": "oto",
  ...
  "weaponEn": "Scroll",
  "birthday": "3月3日",
  "bio": "宇迦のライバル。兎を召喚する。於菟は本来トラを意味し、トラのような勇敢さを示唆。",
  "bioEn": "Uka's rival. Summons rabbits. 'Oto' originally means tiger, hinting at tiger-like bravery.",
  "color": "#F7C9D4",
  "palette": [
   "#F7DCC4",
   "#F0A2B6",
  ...
  "look": "長いウサギ耳（外側ピンク・内側クリーム）のちびくノ一。桜ピンクのおかっぱ、頭に緑の布バンダナを結び、大きな黒目に金色の星형ハイライト、口を開けた笑顔でほお紅あり。淡いピンクの短い着物には濃いピンクのウサギ印、濃いピンクの帯を前で蝶結び、黒い斜め掛けの下緒。右手に「忍」と書いた白ラベルの緑の巻物筒、背中に刀と緑の竹筒（同じ筒の対）を背負い、太もも丈の黒いブーツを履く。",
  "painted": false
 },
 {
  "id": "rotten",
  ...
  "jutsuEn": "Poison Mist",
  "weapon": "毒矢",
  "weaponEn": "Poison Arrow",
  "birthday": "10月10日",
  "bio": "風魔の幹部。アトザの部下。Rotten＝腐る。",
  "bioEn": "An officer of the Fuma clan, serving under Atoza. The name means 'rotten.'",
  "color": "#57402F",
  "palette": [
   "#8CB891",
   "#5B4433",
  ...
  "look": "緑がかった肌のゾンビ忍者。頭頂に黒い矢が刺さり血がにじむ。黒い鉢金（銀プレートに三つの菱形）、右目は黒い眼帯、左目は白目に小さな黒目で見開き、口は半開きで牙がのぞき、あごに緑のよだれが垂れる。茶色の忍装束・半ズボンには暗赤色の血染みが点在し、腕にも血痕とパッチ。黒い斜め掛けの帯と銀の鋲付きベルト、つま先が白い黒靴。",
  "painted": false
 },
 {
  "id": "nagisa",
  ...
  "look": "銀白のふんわり中くらいの髪に黒い鉢金（銀プレート＋三つの菱形）を締めた小麦色肌の忍者。鋭い緑の目、両ほおに小さなそばかす点、口元は濃紺の布マスクで覆う。濃紺〜黒の忍装束に黒の斜め掛け、金色の帯を前で結ぶ。両前腕に灰色の金属手甲、すねに黒い脚甲、親指が割れた黒い足袋靴（底は茶）。背中に刀。",
  "painted": false
 },
 {
  "id": "anne",
  ...
  "birthday": "3月16日",
  "bio": "お調子者。団子の串で影縫い。",
  "bioEn": "A happy-go-lucky type. Pins shadows down with dango skewers.",
  "color": "#4F7A3D",
  "palette": [
   "#F5DCC0",
   "#63402E",
  ...
  "look": "栗色の姫カット（前髪ぱっつん）で、頭頂を赤い紐で結んだ二又に立つちょんまげ。紫の目で口角を上げた微笑み。赤いマフラーを首に巻き、片側が長く後方へたなびく。緑の短い着物に黒の斜め掛け、金色の帯を前で蝶結び。両前腕に灰色の金属手甲、すねに濃灰の脚甲、茶色い底の黒ブーツ。背中に刀。右手に緑・白・桃の三色団子の串を持つ（語彙外）。",
  "painted": false
 },
 {
  "id": "dan",
  ...
  "jutsuEn": "Laser",
  "weapon": "閃光刀",
  "weaponEn": "Laser Sword",
  "birthday": "6月10日",
  "bio": "風魔の幹部。アトザの部下。",
  "bioEn": "An officer of the Fuma clan, serving under Atoza.",
  "color": "#26262B",
  "palette": [
   "#3C3F45",
   "#26262B",
  ...
  "look": "全身黒ずくめの機械仕掛けの忍者。黒い忍者頭巾で頭がすっぽり覆われ、銀色の鉢金（三つの菱形）。顔は金属フェイスプレートで肌は一切見えず、中央の単眼だけが赤く発光、口元は銀の四角いマウスガード。黒装束の縁・肩・脚・足首に赤いライン、胸に格子模様、銀の鋲付きベルト。両手は灰色の金属ガントレット（赤いリング付き）。右手に赤く発光する刀、背中に通常の刀。",
  "painted": false
 },
 {
  "id": "hinanojoh",
  ...
  "look": "人ではなく黄色いヒヨコの姿の忍者。頭頂に3本の羽の逆立ちトサカ、オレンジ色のくちばしと三本指の足、丸く黒い点目に白ハイライト、オレンジのほお紅。黒い鉢巻に3つの菱形リベットが並ぶ銀の鉢金を着け、結び目が左に垂れる。白い短袖の道着に黒いたすき掛けの帯を斜めに回し、腰は赤い帯を前で蝶結び。右手に導火線が星形に着火した茶色い編み玉の爆弾（語彙外）を持つ。翼が短い手になっている。",
  "painted": false
 },
 {
  "id": "torika",
  ...
  "clanEn": "Iga",
  "jutsu": "毒手裏剣",
  "jutsuEn": "Poison Shuriken",
  "weapon": "手裏剣",
  "weaponEn": "Shuriken",
  "birthday": "8月9日",
  "bio": "花を育てるのが好き。",
  "bioEn": "Loves growing flowers.",
  "color": "#26262B",
  "palette": [
   "#F7D9C4",
   "#C4586F",
  ...
  "look": "くすんだローズピンクの中くらいの髪をふんわり内巻きにした少女忍者。額に黒い鉢巻＋2つの菱形リベット付き濃灰の鉢金（結び目は左に垂れる）、マゼンタの大きな目、頬にそばかす、口を開けて怒鳴るような表情。黒い半袖の合わせ襟の忍装束に金のライン、胸に金色の十字（プラス）マーク、腰は金の帯を前で蝶結び、黒いミニスカートの裾にも金の縁取り。黒い襷（たすき）を斜めに掛け、背中の右肩から柄頭が金の刀を覗かせる。右手に大きな四方手裏剣、脚は濃灰のニーソックスに黒いブーツ。",
  "painted": false
 },
 {
  "id": "atoza",
  ...
  "clanEn": "Fuma",
  "jutsu": "逢魔刻",
  "jutsuEn": "Time for Disasters",
  "weapon": "棍棒",
  "weaponEn": "Club",
  "birthday": "11月2日",
  "bio": "風魔の首領級。実は人情派。",
  "bioEn": "A leader-class figure of the Fuma clan. Surprisingly compassionate at heart.",
  "color": "#2A2A30",
  "palette": [
   "#C68A5C",
   "#6D7076",
  ...
  "look": "褐色肌に灰色の乱れ髪で右目が完全に隠れ、覗く左目だけが赤く菱形の瞳。頭の左右から金茶色の角が生える鬼寄りの若者で、赤いマフラーが左後方へ長くたなびく。黒い忍装束の胴に青緑（ティール）の炎模様がプリントされ、黒い襷を斜め掛け、腰は銀の五角プレートが並ぶベルト。両前腕に赤い編み紐＋銀の棘付き手甲、右手に灰色の棘付き金棒（柄尻に黒いリング）、背中の右肩に柄頭が金の刀。黒い足袋ブーツは底が茶色。",
  "painted": false
 },
 {
  "id": "hayate",
  ...
  "weaponEn": "Falcon",
  "birthday": "1月25日",
  "bio": "伊賀の師匠的存在。鷹の名前は「ナルカミ」。",
  "bioEn": "A mentor figure of the Iga clan. His falcon is named 'Narukami.'",
  "color": "#26386B",
  "palette": [
   "#F0C6A0",
   "#55595F",
  ...
  "look": "チャコールグレーの逆立った髪と太い眉、鋭い黄色の目を持つ男忍者。口元は濃紺の忍者マスクで覆う。濃紺の半袖忍装束の胸に銀の四芒星（手裏剣）の紋、黒い襷を斜め掛け、腰は銀の五角プレート付きベルト。左前腕に黒い装甲手甲、右腕には茶色い革の鷹匠グローブ（青い玉と房の飾り付き）を嵌め、そこに黄色い目の茶色い鷹を止まらせている。背中の右肩から柄が黒×金の刀を覗かせ、足元は黒に銀のつま先・茶色い靴底のブーツ。",
  "painted": false
 },
 {
  "id": "uka",
  ...
  "clanEn": "Koka",
  "jutsu": "九尾の焔",
  "jutsuEn": "Flame of Nine-Tailed Fox",
  "weapon": "護符",
  "weaponEn": "Charm",
  "birthday": "2月11日",
  "bio": "於兎のライバル。狐を使役する。お稲荷様（ウカノミタマ）からヒントを得た名前。",
  "bioEn": "Oto's rival. Commands foxes. Named after Ukanomitama, the Inari deity.",
  "color": "#F0EDE8",
  "palette": [
   "#F7DAC0",
   "#D9A45C",
  ...
  "look": "明るい金茶の髪の毛先が白くふさふさに広がる狐娘。大きな狐耳（内側は白い毛）と白い先端の太い狐尻尾、頬に3本ずつのヒゲ跡、紫の目、笑った口から八重歯が覗く。巫女装束で、白い半袖の上衣に赤い斜めの襷と赤い袖口・襟の縁取り、袖に赤い十字（斎の印）、腰は赤い蝶結び帯と赤いプリーツスカート。脚は赤い破線模様の白いニーソックス、足元は黒地に赤い鼻緒の草履。右手はピースサイン、左手に赤い模様入りの護符（御札）を3枚扇状に広げて持つ（語彙外）。",
  "painted": false
 },
 {
  "id": "ganzi",
  ...
  "clanEn": "Koka",
  "jutsu": "幻術・漆黒",
  "jutsuEn": "Illusion of Darkness",
  "weapon": "数珠",
  "weaponEn": "Japamala",
  "birthday": "9月15日",
  "bio": "娘は令、孫は結。クランが違うのは過去の事件から。",
  "bioEn": "Father of Rei and grandfather of Yui. They belong to different clans because of an incident in the past.",
  "color": "#2A2A2C",
  "palette": [
   "#EBBE95",
   "#8E8E90",
  ...
  "look": "白髪まじりの灰色の髪を頭頂で高く逆立てて結った隻眼の老忍者。右目（向かって左）は開いた鋭い目、左目は黒い眼帯。太い口ひげと顎ひげが顔の下半分を覆う。前髪に一房の白いメッシュ。黒い羽織の裏地は朱色で、下は茶色の忍び装束、腰に銀色の帯留め金具。両手首に赤茶色の数珠のブレスレット、胸の前で印を結んでいる。足元は黒い忍び足袋ブーツで甲に銀のプレート、底は茶色。",
  "painted": false
 },
 {
  "id": "yui",
  ...
  "clanEn": "Iga",
  "jutsu": "桜吹雪",
  "jutsuEn": "Flurry of Cherry Blossoms",
  "weapon": "巻物",
  "weaponEn": "Scroll",
  "birthday": "10月15日",
  "bio": "後方支援特化。遠方から忍術を仕掛ける。",
  "bioEn": "Specializes in rear support, casting ninjutsu from afar.",
  "color": "#2B2B2E",
  "palette": [
   "#F4D8C0",
   "#B71C24",
  ...
  "look": "鮮やかな赤いおかっぱ（前髪パッツン）の少女。頭の右側に大きな黒いリボン、その下にピンクの桜の花飾り。まつ毛の大きな黒目とほお紅、微笑んだ口。黒い長着（裾までの着物）で両袖にピンクの桜の花模様、腰に赤い帯。紫色の筒（「忍」と書いた白い札つき・茶色の蓋の巻物入れ）を両手で胸に抱えている。足元は白い鼻緒の黒い下駄／草履。",
  "painted": false
 },
 {
  "id": "fuuta",
  ...
  "jutsuEn": "Fuuton",
  "weapon": "正宗",
  "weaponEn": "Masamune Sword",
  "birthday": "10月1日",
  "bio": "酒飲みでお調子者。戦いを好まず風遁で逃げがち。やるときはやる。",
  "bioEn": "A cheerful drinker. Dislikes fighting and tends to slip away with wind ninjutsu — but delivers when it counts.",
  "color": "#22304F",
  "palette": [
   "#F0CBA0",
   "#7E2E2C",
  ...
  "look": "ファイル名は 018_Futa.png（指示の Fuuta ではない）。赤茶（マルーン）のツンツン頭で、頭上に大きな茶色い編み笠（菅笠）をかぶり、笠の天に赤い巴のような家紋。口の端に緑の葉をくわえてニヤリと笑う。紺地に白の縦縞・裏地が赤い合羽（マント状の肩掛け）を羽織り、下は紺の忍び装束と灰色のベルト。胸に黒い斜めがけのストラップ。刀は背中ではなく左腰に差しており、金色の鍔と柄頭が見える（右手は開いて柄の脇、左手は二本指の印）。足元は紺黒の忍び足袋ブーツで甲は灰色、底は茶色。",
  "painted": false
 },
 {
  "id": "rei",
  ...
  "weaponEn": "Dagger",
  "birthday": "4月22日",
  "bio": "里を守る存在。結の母。忍術・人身御供は最終手段。",
  "bioEn": "Protector of the village. Yui's mother. Her ninjutsu 'Sacrifice' is a last resort.",
  "color": "#A5A5A8",
  "palette": [
   "#F5DCC4",
   "#1E1E22",
  ...
  "look": "黒髪を頭頂で丸くまとめた髷（両脇に長い後れ毛）。金色の台に赤い梅の花の簪を挿す。深緑（ティール）の鉢巻に銀色の額当て＝鉢金（黒い菱形が3つ）で、結び目の布が左側に垂れる。目尻に赤いラインの化粧、無表情でやや鋭い目。灰色の着物に金色の飛沫・水玉模様、紫の帯、内側は白い襟。胸に黒いストラップを斜めがけし、黒い鞘（赤い巻きあり）を提げ、右手に銀色の短刀（黒柄・白い下げ緒）を抜いている。足元は黒い忍び足袋ブーツで甲は白、底は茶色。",
  "painted": false
 },
 {
  "id": "sattva",
  ...
  "file": "Sattva",
  "clan": "天界",
  "clanEn": "Heavenly Realm",
  "jutsu": "涅槃",
  "jutsuEn": "Nirvana",
  "weapon": "円光",
  "weaponEn": "Halo of Light",
  "birthday": "不明",
  "bio": "",
  "bioEn": "",
  "color": "#F0EDE8",
  ...
  "look": "菩薩・天女のような装い。黒髪を頭頂で大きな球状の髷に結い、その前に蓮の意匠の金色の宝冠をかぶる。冠の下から白い薄布（天衣・ヴェール）を頭からかぶって両肩・背中に垂らす。目は閉じてまつ毛が下向き、口元は微笑、ほお紅あり、額の中央に赤い点（白毫）。金の首飾り（丸い飾りと雫）と金色の帯を締めた白いドレープの長衣。右手は親指と人差し指を合わせた印を結び、左手は開いて下ろす。足元は茶色のサンダル（素足）。この画像には後光（光背）は描かれていない。",
  "painted": false
 },
 {
  "id": "nekomata",
  ...
  "jutsuEn": "Kagebunshin",
  "weapon": "妖刀村正",
  "weaponEn": "Bewitched Muramasa Sword",
  "birthday": "8月8日",
  "bio": "とにかく魚が好き。",
  "bioEn": "Simply loves fish.",
  "color": "#26262B",
  "palette": [
   "#EFE0C4",
   "#6B4A38",
  ...
  "look": "三毛猫の獣人忍者。頭は焦茶と橙のぶち毛、顔と胸元はクリーム色で、額に銀の菱形模様プレートが付いた黒い鉢金を巻く。片目は琥珀色の猫目で、もう片方の目は黒い×字の傷（縫い痕）で塞がれている。黒羽織（袖口と裾に金の縁取り）＋濃紺の着物と袴、腰に灰色の金具付きベルト、背中に黒鞘の刀。両手を胸の前で忍びの印に組み、黒足袋＋草履。尻尾は茶と白のまだら。",
  "painted": false
 },
 {
  "id": "janome",
  ...
  "jutsuEn": "Kuchiyose",
  "weapon": "毒手裏剣",
  "weaponEn": "Poison Shuriken",
  "birthday": "7月16日",
  "bio": "白蛇の名前は「オロチ」。口寄せで大蛇を召喚できる。",
  "bioEn": "The white snake is named 'Orochi.' Can summon a giant serpent with Kuchiyose.",
  "color": "#3F6B39",
  "palette": [
   "#F6D6B8",
   "#4E8A55",
  ...
  "look": "緑髪のツンツン頭（頭頂に一房跳ねる）に黒い鉢金を巻いた元気な少年忍者。赤い大きな目で片方の瞳に白い星印、口を開けて笑い牙がのぞく、ほお紅あり。白い大蛇が首から両肩に巻きつき、尾が右腰から膝下まで垂れる。緑の短い忍び着（裾に薄緑の四角い家紋）に紫の帯を蝶結び、胸に黒い斜めの帯。右手に大きな四枚羽の手裏剣、背に刀。脚は素足に濃灰のニーソックス＋黒白の草履。",
  "painted": false
 },
 {
  "id": "benten",
  ...
  "look": "三味線を構えた黒髪の芸妓風の少女。ぱっつん前髪＋左右に大きな輪を作る豪華な髷で、頭頂に金の櫛（扇形の飾り）、両サイドに赤い房のかんざしが垂れる。目元は赤い隈取り風のアイライン、眉間と眉の上に赤い印、目の下に小さな黒点。黒の振袖着物に赤と白の襟、袖と裾に赤い紅葉の散らし模様と白い扇状の柄、胸元に丸い白紋。右手で三味線の棹を持ち、左手に金色の撥。白足袋＋赤い鼻緒の下駄。",
  "painted": false
 },
 {
  "id": "karma",
  ...
  "clanEn": "Fuma",
  "jutsu": "領域・罪業",
  "jutsuEn": "Realm of Sin",
  "weapon": "鎖鎌",
  "weaponEn": "Chain Sickle",
  "birthday": "1月3日",
  "bio": "赤い目で瞳術を掛ける。",
  "bioEn": "Casts eye techniques with crimson eyes.",
  "color": "#2B2B31",
  "palette": [
   "#F5D6B6",
   "#D5D3D2",
  ...
  "look": "銀白のツンツン髪に赤い鋭い目、口の端を上げた不敵な笑みの少年。紫の長いマフラーが左後方へ大きくなびく。片腕（向かって左）だけ濃紺の袖＋棘付きの黒い肩当てと棘付き手甲、もう片腕は素肌に黒い手甲。黒の袖なし忍び着に赤い斜めのたすき、腰回りに太い鉄の鎖が渡り、右手に鎖鎌の鎌（黒い柄・銀の刃）、鎖の反対端に分銅。黒いゆったりズボンに黒白の草履。耳に黒いピアス。",
  "painted": false
 },
 {
  "id": "ichiya",
  ...
  "clanEn": "Saika",
  "jutsu": "忍びいろは",
  "jutsuEn": "Cryptogram of Ninja",
  "weapon": "筆",
  "weaponEn": "Writing Brush",
  "birthday": "11月2日",
  "bio": "伝令のスペシャリスト。彼が書く虹色の文字は空を舞い、世界にメッセージを届ける。",
  "bioEn": "A messenger specialist. The rainbow letters he writes dance through the sky, delivering messages to the world.",
  "color": "#2A272C",
  "palette": [
   "#F6D9BC",
   "#52396B",
  ...
  "look": "紫髪のもふもふ頭に同色の獣（猫／狼）の耳（内側は淡いピンク）、半目で気だるげな紫の瞳、頬に橙のチーク線。オレンジと茶の市松模様のマフラーで口元をすっぽり覆い、マフラーには黒い糸目のような模様が描かれている。黒い長羽織の下に紫の着物、腰に銀色の角ばったベルト。右手に大きな絵筆（茶の柄・白い穂先）を握り、そこから虹色の絵の具の帯が体の左右へ大きく弧を描いて渦巻く（左側は輪、右側は炎のように立ち上がり赤い滴が飛ぶ）。足元は黒い足袋＋草履。",
  "painted": false
 },
 {
  "id": "nemu",
  ...
  "clanEn": "Koka",
  "jutsu": "動植綵絵",
  "jutsuEn": "Colourful Realm of Living Beings",
  "weapon": "絵筆",
  "weaponEn": "Painting Brush",
  "birthday": "2月3日",
  "bio": "イチヤの姉。自由奔放。パートナーの名前はピヨチ（ひよこ）とウサピ（うさぎ）。",
  "bioEn": "Ichiya's older sister. Free-spirited. Her partners are Piyochi (a chick) and Usapi (a rabbit).",
  "color": "#7B3FBF",
  "palette": [
   "#F7D3B2",
   "#4A3348",
  ...
  "look": "猫耳（外側は濃い紫、内側は白）と長いふさふさ尻尾を持つ少女。濃い紫のもさっとした中くらいの髪に、赤・黄・緑・青緑・オレンジのレインボーのメッシュが何本も入る。瞳は紫で、瞳孔が黄色い星型。舌をぺろっと出して笑う。紫の短い忍び着物に黒い帯を斜めがけ、裾に薄紫のひし形模様。右手に赤茶の柄の絵筆を持ち、そこから虹色の絵の具しぶきが左右に大きく飛び散る（これが最大の特徴）。黒いブーツの靴底だけ紫。両脇に相棒マスコット2体が浮かぶ＝左＝黒い鉢巻をした黄色いヒヨコ、右＝緑の鉢巻をしたピンクのウサギ耳のおばけ。",
  "painted": false
 },
 {
  "id": "karura",
  ...
  "weaponEn": "Wings",
  "birthday": "9月6日",
  "bio": "伊賀の山奥でひっそりと里を守っている。",
  "bioEn": "Quietly protects a village deep in the mountains of Iga.",
  "color": "#26262B",
  "palette": [
   "#F5CFAB",
   "#33344B",
  ...
  "look": "背中に黒い鳥の翼を生やした忍。濃紺〜黒の重い流し髪が右目を完全に隠し、見えている左目は明るいエメラルドグリーン。口元は黒い布マスクで覆う。黒い着物風の上衣に、紫地＋金の縁取りのサスペンダー状の帯を左右にかけ、そこに白い大玉（真珠のような球）が計4つ付く。腰は紫のリボン結び。下は黒い巻きスカート。右手を立てて印を結び、その手首に青い数珠と赤い房。黒いブーツの膝上に紫のライン、靴底は茶色。",
  "painted": false
 },
 {
  "id": "xiaolan",
  ...
  "weaponEn": "Tai Chi",
  "birthday": "10月28日",
  "bio": "口寄せでパンダを呼ぶ。パンダの名前は「リーリー（力力）」。パンダは巨大化できる。",
  "bioEn": "Summons a panda with Kuchiyose. The panda is named 'Lili (力力)' — and it can grow to giant size.",
  "color": "#E0A81E",
  "palette": [
   "#FBDABE",
   "#E8703A",
  ...
  "look": "オレンジ髪を頭の左右で大きな二つおだんごにした元気な少女。紫の大きな瞳で口を開けて笑い、右手はピースサイン。からし色（マスタード）の短い忍び着物に黒い縁取り、胸に小さな黒ひし形の紋、腰は白い帯を蝶結び。両腕（手首と二の腕）に白い包帯を巻く。背中に黒鞘＋金の鍔の刀を右肩から覗かせ、さらに背中に赤い布をまとった白黒のパンダのぬいぐるみを背負っている（笑顔で目を細めたパンダ）。脚はグレーのニーハイに黒の靴。",
  "painted": false
 },
 {
  "id": "aum",
  ...
  "clanEn": "Fuma",
  "jutsu": "巨人の一撃",
  "jutsuEn": "A Titan's Blow",
  "weapon": "棍棒",
  "weaponEn": "Club",
  "birthday": "5月9日",
  "bio": "アトザの弟。巨大化できる。",
  "bioEn": "Atoza's younger brother. Can grow to giant size.",
  "color": "#26262B",
  "palette": [
   "#6FA8D8",
   "#4A4266",
  ...
  "look": "青灰色の肌をした鬼の忍。濃い紫紺の髪が炎のように高く逆立ち、後ろは緑のゴムで束ねた爆発ポニーテール。額に銀のプレート（ひし形3つの刻印）付き鉢金、その上に一本だけベージュの角が生える。赤い目、口を開けて上下に牙。黒い忍装束の胴部分だけ赤地で、黒い炎のような模様が入る。黒い襷を斜めに掛け、腰は銀の鋲付きベルト。両腕に棘付きの鉄手甲。右手（向かって左）に自分の背丈ほどある大きな棘付き金棒を地面近くまで下げて持ち、背中に黒鞘＋金の刀。足は黒い忍靴。",
  "painted": false
 },
 {
  "id": "konga",
  ...
  "jutsuEn": "Kagebunshin",
  "weapon": "拳",
  "weaponEn": "Bare Knuckle",
  "birthday": "9月24日",
  "bio": "甲賀のくのいちに修行をつけるコーチ的存在。",
  "bioEn": "A coach-like figure who trains the kunoichi of the Koka clan.",
  "color": "#7B3F9E",
  "palette": [
   "#8C8C90",
   "#3A3A3F",
  ...
  "look": "筋肉質のゴリラの忍。体毛は濃いチャコールグレー、顔・胸・手足はやや明るいグレー。頭頂はつるりとした黒っぽいドーム状で、紫の鉢巻に銀のプレート（ひし形3つの刻印）、結び目が左側にひらひら垂れる。白目のはっきりした鋭い目でにやりと歯を見せる。上半身は裸で、紫のたすきを右肩から斜めがけ。腰は銀の鋲付きベルト、下は濃紺のズボン。裸足でグレーの足。背中に黒鞘＋金の刀を差し、右手（向かって右）は親指を立てたサムズアップ、左手は握り拳。",
  "painted": false
 },
 {
  "id": "shion",
  ...
  "clanEn": "Iga",
  "jutsu": "野アザミ",
  "jutsuEn": "Wild Thistle",
  "weapon": "鉤爪",
  "weaponEn": "Iron Claw",
  "birthday": "9月28日",
  "bio": "幼い頃に集落が鬼に襲われ、令が面倒を見ている。人見知りだが、餡音にはなついている。",
  "bioEn": "Her village was attacked by oni when she was young, and Rei now looks after her. Shy with strangers, but very attached to Anne.",
  "color": "#34424E",
  "palette": [
   "#F6D9BC",
   "#8A2A33",
  ...
  "look": "深紅（ワインレッド）の髪を紫のリボンで高いポニーテールに結んだ気の強い少女。黒い羽毛状のファー襟当て（肩まで覆う）を付け、濃紺グレーの短い着物風上衣＋オレンジと黒の横縞の帯、その上から紫の帯締めを蝶結び。両手に鋼色の三本爪ガントレット（鉤爪手甲・手首は紫バンド）。太腿までの濃灰ニーソックスに黒いショートブーツ（靴底は茶）。眉が太くつり上がった不機嫌顔で頬に赤み。",
  "painted": false
 },
 {
  "id": "seori",
  ...
  "clanEn": "Saika",
  "jutsu": "丑の刻参り",
  "jutsuEn": "Ushi-no-Koku Mairi",
  "weapon": "木槌",
  "weaponEn": "Wooden Mallet",
  "birthday": "3月3日",
  "bio": "名称は瀬織津姫から。パートナーの名前は「ミタマ」。",
  "bioEn": "Named after the goddess Seoritsu-hime. Her partner is named 'Mitama.'",
  "color": "#F1EEE9",
  "palette": [
   "#F8DDC3",
   "#A8C0D6",
  ...
  "look": "水色がかった銀髪ロングの少女。頭に黒い鉄輪（五徳）を被り、白いろうそく3本に火が灯る「丑の刻参り」意匠＝語彙のcrownはこの鉄輪＋蝋燭を指す。白い着物（衿は黒帯状）で袖口の内側がピンク、腰に太い紫の帯を前で結ぶ。下は黒い短パン、白い膝上足袋（紫の破線模様）に紫鼻緒・茶底の草履。八重歯（牙）を見せて笑う。右手に持つのは棘のない木槌（金づち）で、金棒ではない。左隣に水色の幽霊の相棒（白い三角頭巾＝天冠を巻いた丸い姿・緑の目・尾は渦巻き）が浮いている。",
  "painted": false
 },
 {
  "id": "quon",
  ...
  "clanEn": "Saika",
  "jutsu": "猫の目の選択",
  "jutsuEn": "A Cat's Eye Choice",
  "weapon": "鬼火",
  "weaponEn": "Onibi",
  "birthday": "10月8日",
  "bio": "「幸福な未来」を選択する能力を持つ。年齢不詳。猫又と同じ里の出身で猫又より年上。神出鬼没。一人称は「わし」。名称は量子（Quantum）から。",
  "bioEn": "Holds the power to choose a 'happy future.' Age unknown. From the same village as Nekomata and older than her. Appears and vanishes like a phantom. Speaks with the archaic first-person 'washi.' The name comes from 'Quantum.'",
  "color": "#2E5C9E",
  "palette": [
   "#F7DCC0",
   "#2C63D6",
  ...
  "look": "青髪でアホ毛が立った猫又の少年。左右で色が違うオッドアイ（画面左＝金色、画面右＝青。eyeには青を採用）。青い猫耳（内側はピンク・耳の付け根に白毛）、頬に3本ずつの黒いヒゲ線、牙。首に長くたなびくオレンジのマフラー。青い着物＋白の帯、その上に黒い羽織（袖が黒）。背中に黒鞘＋金の鐺の刀を背負う。青い猫尻尾の先だけ白。黒のニーハイソックス風脚絆に黒の足袋靴（つま先が白・底は茶）。両手は握り拳で武器は持っていない。体の左右に青白い人魂の炎が2つ浮いている（幽霊の姿ではなく炎）。",
  "painted": false
 },
 {
  "id": "magoichi",
  ...
  "clanEn": "Saika",
  "jutsu": "一発必中",
  "jutsuEn": "One-shot Sure-hit",
  "weapon": "銃",
  "weaponEn": "Pistols",
  "birthday": "5月1日",
  "bio": "雑賀クランの首領。雑賀の里に帰るのは稀で、里のことは弁天に任せている。今は海に出て海賊のように動いているらしい。",
  "bioEn": "Leader of the Saika clan. Rarely returns to the village, leaving its affairs to Benten. Now said to roam the seas like a pirate.",
  "color": "#26262B",
  "palette": [
   "#F5D3B0",
   "#2C7A4A",
  ...
  "look": "濃い緑のツンツン頭に細い黒のヘッドバンド（額に巻いた革ひも・金属プレートは無い）を締めたニヒルな男。画面右側の目に金の花紋（梅鉢）が付いた黒い眼帯、見えている目は黄緑。口の端に真鍮の煙管（キセル）をくわえる。首元に緑のギザギザした襟巻き。前を開けた黒いロングコート（羽織）で裏地は赤、肩に白い×のステッチ。上半身は裸で胸と両腕に濃緑の唐草／波状の刺青。黒い袴風パンツを白い紐帯で前結び、黒い足袋靴（つま先が白・底は茶）。両手にリボルバー拳銃を1丁ずつ（heldのrifleは短銃身の回転式拳銃として指定）。",
  "painted": false
 },
 {
  "id": "ibuki",
  ...
  "clanEn": "Fuma",
  "jutsu": "泰山府君祭",
  "jutsuEn": "Ritual of Taizan Fukun",
  "weapon": "呪符",
  "weaponEn": "Talisman Paper",
  "birthday": "12月31日",
  "bio": "ヤーマはイブキの能力に応じた姿になる。イブキが未熟であるためかわいい姿で現界している。イブキは「気吹戸主」から、ヤーマは「閻魔大王」に由来。",
  "bioEn": "Yama takes a form that matches Ibuki's power — appearing in a cute form because Ibuki is still inexperienced. Ibuki derives from 'Ibukidonushi,' and Yama from 'King Enma.'",
  "color": "#26262B",
  "palette": [
   "#F7DDC0",
   "#4B4570",
  ...
  "look": "暗い紫紺のおかっぱ髪の頭頂を金のリングで結い上げた（ちょんまげ状の束）陰陽師風の少年。緑の目に紫のアイシャドウ、口角を上げた不敵な微笑。黒い着物＋黒の帯、その上に黒い羽織を羽織り、羽織の縁と裾に赤いライン・赤い房飾り（打紐）、裏地は紫。首に金色の玉3つの数珠風ネックレス。下は紫の袴、黒い草履（甲・底に金の縁）。右手は人差し指と中指を立てた刀印（印を結ぶポーズ）、左手の上に紫の炎に包まれたピンクの人型の式神（紙の呪符・「ふ」のような文字入り）を浮かべる。左肩に緑色の小鬼（オレンジの角2本・紫の目・鋭い歯・小さな翼状の耳）の相棒が乗っている。",
  "painted": false
 },
 {
  "id": "oen",
  ...
  "jutsuEn": "Ito Myaku",
  "weapon": "笈",
  "weaponEn": "Japanese Portable Storage",
  "birthday": "4月2日",
  "bio": "実家は雑賀クラン。里を離れて甲賀クランに忍術の修行に来ている。",
  "bioEn": "Born to the Saika clan. Left her village to train in ninjutsu with the Koka clan.",
  "color": "#CE5A1D",
  "palette": [
   "#F7DDC2",
   "#6F9A52",
  ...
  "look": "緑髪・緑猫耳の小柄な猫又忍者。前髪の右寄りに白いメッシュが1本入り、耳の内側は淡いピンク＋白い房毛。黒縁の丸メガネをかけ、オレンジ色の丸い瞳で口を開けて笑い、上あごに小さな牙。緑の着物（黒い襟＋オレンジの飾り紐＋白い帯を蝶結び）の上に、白い四弁花を散らしたオレンジの羽織を肩から羽織る。背中に黒い金具付きの木箱（行商の背負い箱）を白い肩紐で背負い、緑色で先端だけ白い猫の尻尾が伸びる。脚は白縁の濃灰色の脛当て（黒足袋）＋緑鼻緒・茶色台の下駄。両手はグーに握って前に構えている。",
  "painted": false
 },
 {
  "id": "izuna",
  ...
  "clanEn": "Koka",
  "jutsu": "飯綱の法",
  "jutsuEn": "Witchcraft of Izuna",
  "weapon": "なし",
  "weaponEn": "None",
  "birthday": "7月21日",
  "bio": "宇迦の姉。",
  "bioEn": "Uka's older sister.",
  "color": "#F0EDE8",
  "palette": [
   "#F8DFC6",
   "#221F1E",
  ...
  "look": "黒髪ロングの獣耳巫女。黒い狐（狼）耳の内側は白い房毛、毛先の内側と顔まわりの一房が水色に染まったインナーカラー。左目の下に泣きぼくろがあり、紫の瞳で右目はウインク、口を開けて笑う。白衣（襟と袖口に黒のライン）＋金色の帯締め＋臙脂の緋袴で、袴の前で大きな赤いリボン結び。腰の後ろから黒くて毛先が白い太いふさふさの尻尾。足元は白足袋＋赤鼻緒・茶色台の草履。右手は人差し指を立て、左手を横に開いたポーズ。",
  "painted": false
 },
 {
  "id": "sekishusai",
  ...
  "look": "黒髪を高く逆立てた剣士。頭頂はオレンジの紐で束ねた大きなトゲ状の束髪で、前髪の中央から右にかけて銀白の稲妻状メッシュが走る。太い眉、琥珀色のつり目、口を開けて笑い小さな牙。あご下に黒い小さなヒゲ（顎髭のような模様）。黒い着物の上に白い立ち襟・白縁の黒羽織を重ね、袖の下半分に赤い炎の模様と黒い円紋（家紋）。腰は臙脂の太い兵児帯。左腰に金鍔・市松柄の柄巻きの打刀と脇差の2本差しで、柄を手で押さえている。黒袴に黒の草履＋白鼻緒。",
  "painted": false
 },
 {
  "id": "sasagane",
  ...
  "look": "蜘蛛をモチーフにした花魁。抜けるように白い肌、額に赤い菱形の印、紫のアイシャドウと極太のまつげ、ピンク色でハート型の瞳孔、口元に牙。黒い大きな花魁髷から左右に紫の縞が入った角のような髪の張り出しが伸び、金の櫛・金の平打ち簪（先端に赤い玉）を放射状に何本も挿し、頭頂には紫の蝶柄の金地の櫛飾り。黒地の打掛（裏地と縁は臙脂、白と金の渦巻き・輪紋を大きく配置）を羽織り、内側は紫と金地に紫の蝶柄の着物、白＋紫の襟。前帯は金地に巨大な黒い蜘蛛の意匠。右手に黒と金の煙管を持つ。黒漆に金縁の高下駄＋白足袋・赤鼻緒。",
  "painted": false
 }
];
